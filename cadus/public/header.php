...
<header>
    <nav class="navigation">
        <ul class="navFlex">
            <li>
                <a class="navFlex" href="index.php">
                    <img src="assets/img/accueil/cropped-128521182_861230594633479_523372672255009567_n-1-6-removebg-preview.png"
                         alt="logo">
                </a>
            </li>
            <li>
                <ul class="navFlex" id="navText">
                    ...
                    <li><a href="ce-qu'il-faut-savoir.php">Ce qu'il faut savoir</a></li>
                    <li id="votreEspace">
                        <a href="mon-espace.php">Votre espace
                            ...
                            <?php if ($trousseau->isUserConnected()): ?>
                                <div class="login-options">
                                    <p>
                                        ...
                                        <a href="mon-espace.php"><?= htmlspecialchars($trousseau->findUserByEmail($_COOKIE['email'])->getPrenom()) ?></a>
                                    </p>
                                    <p>
                                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                            ...
                            <?php if (!$trousseau->isUserConnected()): ?>
                                <div class="login-options">
                                    <p>
                                        ...
                                        <a href="se-connecter.php">Se connecter</a></p>
                                    <p>
                                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="creer-un-compte.php">Créer un compte</a></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </li>
